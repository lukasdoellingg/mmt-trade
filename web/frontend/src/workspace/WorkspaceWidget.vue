...
<template>
  <div class="ws-widget" :style="style" @pointerdown="bringToFront(widget.id)">
    ...
    >
      ...
      <button v-if="!noClose" data-no-drag class="ws-icon ws-close" title="Close" @click.stop="onClose">
        &times;
      </button>
    </header>
    <div class="ws-body">
    ...
    <template v-if="!locked">
      ...
      ></span>
      <span
        class="ws-edge ws-e-s"
        @pointerdown="(e) => onResizeDown('s', e)"
        @pointermove="onPointerMove"
        @pointerup="onPointerUp"
      ></span>
      <span
        class="ws-edge ws-e-e"
        @pointerdown="(e) => onResizeDown('e', e)"
        @pointermove="onPointerMove"
        @pointerup="onPointerUp"
      ></span>
      <span
        class="ws-edge ws-e-w"
        @pointerdown="(e) => onResizeDown('w', e)"
        @pointermove="onPointerMove"
        @pointerup="onPointerUp"
      ></span>
      <span
        class="ws-edge ws-c-ne"
        @pointerdown="(e) => onResizeDown('ne', e)"
        @pointermove="onPointerMove"
        @pointerup="onPointerUp"
      ></span>
      <span
        class="ws-edge ws-c-nw"
        @pointerdown="(e) => onResizeDown('nw', e)"
        @pointermove="onPointerMove"
        @pointerup="onPointerUp"
      ></span>
      <span
        class="ws-edge ws-c-se"
        @pointerdown="(e) => onResizeDown('se', e)"
        @pointermove="onPointerMove"
        @pointerup="onPointerUp"
      ></span>
      <span
        class="ws-edge ws-c-sw"
        @pointerdown="(e) => onResizeDown('sw', e)"
        @pointermove="onPointerMove"
        @pointerup="onPointerUp"
      ></span>
    </template>
