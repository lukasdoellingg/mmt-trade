/**
 * Shared `/ws/heatmap` client — one WebSocket per (symbol, timeframe, aggregate) key.
 * Chart OB workers and order-flow ladders subscribe instead of opening parallel sockets.
 */
...
/**
 * Subscribe to heatmap frames. Returns unsubscribe — call on pause/unmount.
 */
...
/** Active hub connections (devtools / regression). */
