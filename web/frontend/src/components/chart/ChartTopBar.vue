...
import { chartDevicePixelRatio } from '../../chart/chartDisplayMetrics';
...
<template>
  <div class="topbar">
    ...
    <button
      class="ic-btn"
      :class="{ on: settings.obHeatmap }"
      title="Order Book heatmap"
      @click="settings.obHeatmap = !settings.obHeatmap"
    >
    ...
    <button
      class="ic-btn"
      :class="{ on: settings.footprint }"
      title="Footprint"
      @click="settings.footprint = !settings.footprint"
    >
      <svg width="14" height="14" viewBox="0 0 14 14">
    ...
    <button
      class="ic-btn"
      :class="{ on: settings.vpvr }"
      title="VPVR"
      @click="settings.vpvr = !settings.vpvr"
    >
      <svg width="14" height="14" viewBox="0 0 14 14">
    ...
    <button
      class="ic-btn"
      :class="{ on: settings.liquidations }"
      title="Liquidations"
      @click="settings.liquidations = !settings.liquidations"
    >
      <svg width="14" height="14" viewBox="0 0 14 14">
    ...
    <div class="dd-wrap">
      <button class="dd-btn" @click="onIndicatorsClick">
    ...
    <button
      class="ic-btn"
      :class="{ on: settings.quoteUsd }"
      title="Toggle quote currency"
      @click="toggleQuoteUsd"
    >
      {{ settings.quoteUsd ? '$ USD' : 'BASE' }}
    </button>
    ...
    <div class="dd-wrap">
      <button class="dd-btn" @click="onOrderflowClick">
    ...
    <div class="dd-wrap">
      ...
      <div v-if="addWidgetOpen" class="dd-menu" @click.stop>
        <button
          ...
          class="dd-row"
          @click="
            w.type === 'chart' ? addChart() : addOrderflow();
            addWidgetOpen = false;
          "
        >
          {{ w.entry.label }}
